...
<div>
    ...
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-3xl font-bold text-gray-900">Transaction Records</h2>
        <a href="<?= base_url('/transactions/create') ?>" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-200 flex items-center">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        <form method="GET" class="flex gap-4 flex-wrap">
            <input type="text" name="search_invoice_number" placeholder="Search Invoice Number..." value="<?= esc($filters['invoice_number']) ?>" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
            <input type="text" name="search_pic_name" placeholder="Search PIC Name..." value="<?= esc($filters['pic_name']) ?>" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
            <select name="limit" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">
            ...
            <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200">Search</button>
            <a href="<?= base_url('/transactions') ?>" class="bg-gray-400 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded-lg transition duration-200">Reset</a>
        </form>
    </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-100 border-b-2 border-gray-300">
                        <tr>
                            <th class="px-6 py-3 text-left text-gray-700 font-bold">Invoice Number</th>
                            <th class="px-6 py-3 text-left text-gray-700 font-bold">Invoice Date</th>
                            <th class="px-6 py-3 text-left text-gray-700 font-bold">Customer</th>
                            <th class="px-6 py-3 text-left text-gray-700 font-bold">PIC Name</th>
                            <th class="px-6 py-3 text-right text-gray-700 font-bold">Grand Total</th>
